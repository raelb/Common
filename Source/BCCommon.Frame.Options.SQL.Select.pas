...
begin
  ...
  AlignSliders(Result.TabSheetColumnList, 11);
  AlignSliders(Result.TabSheetSubquery, 11);
  AlignSliders(Result.TabSheetFromJoinClause, 11);
  AlignSliders(Result.TabSheetAndOrKeyword, 11);
end;
